...
const BirdNest = () => {
  ...
  useEffect(() => {
    ...
    const birdNestFeaturesRight = document.querySelectorAll(".bn-feature-right");
  ...
  return <div className="bn-container">
    ...
    <div className="bn-features">
      <div className="bn-features-col">
        <p className="bn-features-text bn-feature-right">Personal profiles with <strong>questionnaires</strong> and displayed traits geared towards housing preferences</p>
        <p className="bn-features-text bn-feature-left"><strong>Sorting algorithms</strong> that rank potential roommates based on number of matched preferences</p>
      </div>
      <div className="bn-features-col bn-col-right">
      <p className="bn-features-text bn-feature-right"><strong>Filtering algorithms</strong> which, on top of the sorting feature, allows users to apply more granular and variable specifications on which type of roommate is desired</p>
      <p className="bn-features-text bn-feature-left"><strong>Messaging</strong>, profile editing, <strong>matchmaking</strong>, image uploading, and much, much more</p>
      </div>
    </div>
    <div className="bn-separator" />
      <h3 className="bn-features-header">Graphics</h3>
      <p className="bn-subheader"> From left to right: Profile screen, Home screen, Message feed, and Chat screen</p>
    <div className="bn-images-container">
      <div className="bn-image-col">
        <img className="bn-image" src={imagesIndex.BirdNestProfile} alt="Bird Nest profile screen" />
        <img className="bn-image" src={imagesIndex.BirdNestHome} alt="Bird Nest home screen" />
      </div>
      <div className="bn-image-col">
        <img className="bn-image" src={imagesIndex.BirdNestMessageFeed} alt="Bird Nest message feed screen" />
        <img className="bn-image" src={imagesIndex.BirdNestChat} alt="Bird Nest chat screen" />
      </div>
    </div>
  </div>;
};
