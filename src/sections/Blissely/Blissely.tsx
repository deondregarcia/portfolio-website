...
const featureObserver = new IntersectionObserver(function (
  entries,
  featureObserver
) {
...
const graphicObserver = new IntersectionObserver(
  function (entries, graphicObserver) {
    entries.forEach((entry) => {
      if (!entry.isIntersecting) {
        return;
      } else {
...
const Blissely = () => {
  ...
  return (
    <div className="blissely-container">
      ...
      <div id="blissely" className="blissely-id" />
      ...
      <a
        className="blissely-link"
        href="https://blissely.herokuapp.com"
        target="_blank"
      >
      ...
      <div className="blissely-description">
        ...
        <div className="blissely-what">
          <div className="blissely-header-wrapper">
            ...
            <p className="blissely-header-text">
              Blissely is a full stack, production-ready web app where friends
              and family can create and edit shared bucket lists.
            </p>
            <p className="blissely-header-text">
              Privacy settings for bucket lists are configured based on four
              different categories:
            </p>
          </div>
          <div className="blissely-text category-one">
            <h4>Private</h4>
            Can only be viewed by its creator/owner
          </div>
          <div className="blissely-text category-two">
            <h4>Shared</h4> Can only be viewed by its owner and friends that the
            owner chooses to share it with
          </div>
          <div className="blissely-text category-three">
            <h4>Public - Friend</h4> Can be viewed by the owner and all of the
            owner's friends
          </div>
          <div className="blissely-text category-four">
            <h4>Public - Random</h4> Can be viewed by anyone, even if not logged
            in
          </div>
        </div>
        <div className="blissely-separator" />
        <div className="blissely-features">
          ...
          <div
            className="blissely-text feature-one feature-bubble"
          ...
          <div
            className="blissely-text feature-two feature-bubble"
            style={{ animationDuration: "900ms" }}
          >
            Extensive <strong>authorization flows</strong> which protect routes
            and block content based on a myriad of considerations for maximum
            privacy configurations for the user
          </div>
          <div
            className="blissely-text feature-three feature-bubble"
          ...
          <div
            className="blissely-text feature-four feature-bubble"
            style={{ animationDuration: "800ms" }}
          >
            Responsive UI design with highly interactive components and flexible
            CSS breakpoints
          </div>
          <div
            className="blissely-text feature-five feature-bubble"
            style={{ animationDuration: "1300ms" }}
          >
            <strong>Database normalization</strong> up to Third Normal Form
          </div>
          <div
            className="blissely-text feature-six feature-bubble"
      ...
      <p className="blissely-subheader">
        Control flow for authorization checks, database schema, and website
        screenshots
      </p>
      <div className="blissely-details">
        <div className="blissely-graphics-wrapper">
          <img
            className="blissely-graphic-flow graphic-fade"
        ...
        <div className="blissely-graphics-wrapper">
          <img
            className="blissely-screenshot graphic-fade"
            style={{ animationDelay: "400ms" }}
            src={imagesIndex.BlisselyLanding}
            alt="Blissely landing page"
          />
          <img
            className="blissely-screenshot graphic-fade"
            style={{ animationDelay: "800ms" }}
            src={imagesIndex.BlisselyHome}
            alt="Blissely sample home page"
          />
        </div>
      </div>
    </div>
